...
def aplicar_layout_glass_acima_logo(img, dados):
    ...
    # posição mais alta para ficar acima do logo central
    y1 = int(altura * 0.25)
    y2 = y1 + int(altura * 0.11)
...
def aplicar_layout_glass_footer(img, dados):
    ...
    altura_card = int(altura * 0.11)

    # posição do logo (mesma lógica do logo_central)
    margem_logo = int(altura * 0.05)

    # estimativa da altura do logo (aprox)
    altura_logo = int(altura * 0.12)

    # posiciona o card acima do logo
    y2 = altura - altura_logo - margem_logo - int(altura * 0.005)
    y1 = y2 - altura_card
